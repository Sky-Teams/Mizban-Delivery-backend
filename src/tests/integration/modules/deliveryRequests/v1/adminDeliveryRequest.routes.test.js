  ...
  it('should create a delivery request successfully', async () => {
    const deliveryData = {
      ...
      receiver: {
        ...
        phone: '0790909090',
        address: 'Herat',
        location: { type: 'Point', coordinates: [34.35, 62.2] },
      },
      pickupLocation: { type: 'Point', coordinates: [34.35, 62.2] },
      dropoffLocation: { type: 'Point', coordinates: [34.36, 62.3] },
      paymentType: 'COD',
      amountToCollect: 100,
  ...
  it('should fail if required field is missing', async () => {
    const deliveryData = {
      ...
      receiver: {
        ...
        phone: '0790909090',
        addressText: 'Herat',
        location: { coordinates: [34.35, 62.2] },
      },
      pickupLocation: { coordinates: [34.35, 62.2] },
      dropoffLocation: { coordinates: [34.36, 62.3] },
      paymentType: 'COD',
      amountToCollect: 100,
    };
